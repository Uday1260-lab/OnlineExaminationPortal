...
<body>
	<header>
		...
		<div class="list">
			<h3 class="list-heading">List Of User Reports</h3>
			<hr class="list-hr">
			<c:if test="${reportList == null}">
				<div class="list-welcome">
					<p class="list-welcome-p">No reports Saved!!</p>
				</div>
			</c:if>
			<c:if test="${reportList != null}">
				<table class="list-table">
					<thead class="list-table-thead">
						<tr>
							<th class="list-table-thead-th">Report Id</th>
							<th class="list-table-thead-th">Date</th>
							<th class="list-table-thead-th">Name</th>
							<th class="list-table-thead-th">Email</th>
							<th class="list-table-thead-th">Exam Topic</th>
							<th class="list-table-thead-th">Passing Score</th>
							<th class="list-table-thead-th">Score</th>
							<th class="list-table-thead-th">grade</th>
							<th class="list-table-thead-th">Remark</th>
							<th class="list-table-thead-th">Session Id</th>
						</tr>
					</thead>
					<tbody class="list-table-tbody">
						<c:forEach var="reportListItem" items="${reportList}">
							<tr>
								<td><c:out value="${reportListItem.reportId}" /></td>
								<td><c:out value="${reportListItem.date}" /></td>
								<td><c:out value="${reportListItem.name}" /></td>
								<td><c:out value="${reportListItem.email}" /></td>
								<td><c:out value="${reportListItem.topic}" /></td>
								<td><c:out value="${reportListItem.passScore}" /></td>
								<td><c:out value="${reportListItem.score}" /></td>
								<td><c:out value="${reportListItem.grade}" /></td>
								<td><c:out value="${reportListItem.remark}" /></td>
								<td><c:out value="${reportListItem.sessionId}" /></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
